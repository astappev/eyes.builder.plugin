...
m.__applitools_is_send_on_recording = "Send data on recording";
m.__applitools_is_send_on_recording_description = "If checked we will send screenshots to Applitools during recording.";
